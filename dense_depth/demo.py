...
class GLWidget(QtOpenGL.QGLWidget):
    def __init__(self, parent=None):
        ...
        self.rgb = np.load(r'D:\Studies\Prometheus\Depth\DenseDepth\demo_rgb.npy')
        self.depth = resize(np.load(r'D:\Studies\Prometheus\Depth\DenseDepth\demo_depth.npy'), (240,320))
        self.col_vbo = None
        self.pos_vbo = None
        self.updateRGBD()
